// gcc -O3 -march=native -mavx2 -flto -funroll-loops -fomit-frame-pointer -fopenmp sha3_avx2.c sha3_avx2_test.c -o sha3_avx2_test
// gcc -O3 -mavx2 sha3_avx2.c sha3_avx2_test.c -o sha3_avx2_test
...
int main() {
    ...
    printf("==== Single SHA3 ====\n");
    test_single("SHA3-224", sha3_224, SHA3_224_DIGEST_LENGTH);
    test_single("SHA3-256", sha3_256, SHA3_256_DIGEST_LENGTH);
    test_single("SHA3-384", sha3_384, SHA3_384_DIGEST_LENGTH);
    test_single("SHA3-512", sha3_512, SHA3_512_DIGEST_LENGTH);

    printf("==== AVX2 8x SHA3 ====\n");
    test_8x("SHA3-224 8x", sha3_8x_224, SHA3_224_DIGEST_LENGTH);
    test_8x("SHA3-256 8x", sha3_8x_256, SHA3_256_DIGEST_LENGTH);
    test_8x("SHA3-384 8x", sha3_8x_384, SHA3_384_DIGEST_LENGTH);
    test_8x("SHA3-512 8x", sha3_8x_512, SHA3_512_DIGEST_LENGTH);
